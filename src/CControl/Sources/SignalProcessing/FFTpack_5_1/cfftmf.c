/* cfftmf.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int cfftmf_(integer *lot, integer *jump, integer *n, integer 
	...
	*work, integer *lenwrk, integer *ier)
{
    ...
    /* Local variables */
    static integer iw1;
    extern /* Subroutine */ int cmfm1f_(integer *, integer *, integer *, 
