/* cmfgkf.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int cmfgkf_(integer *lot, integer *ido, integer *ip, integer 
	...
	wa)
{
    ...
    /* Local variables */
    static integer i__, j, k, l, m1, m2, jc, lc, ki;
    static real sn;
    static integer m1d, m2s;
    static real wai, war;
