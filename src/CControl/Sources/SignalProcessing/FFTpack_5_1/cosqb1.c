/* cosqb1.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int cosqb1_(integer *n, integer *inc, real *x, real *wsave, 
	real *work, integer *ier)
{
    ...
    extern /* Subroutine */ int rfft1b_(integer *, integer *, real *, integer 
