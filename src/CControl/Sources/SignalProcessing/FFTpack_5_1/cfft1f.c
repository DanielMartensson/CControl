/* cfft1f.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int cfft1f_(integer *n, integer *inc, complex *c__, integer *
	...
	integer *ier)
{
    ...
    /* Local variables */
    static integer iw1;
    extern /* Subroutine */ int c1fm1f_(integer *, integer *, complex *, real 
