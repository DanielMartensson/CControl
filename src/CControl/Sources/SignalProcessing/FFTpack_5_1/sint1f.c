/* sint1f.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int sint1f_(integer *n, integer *inc, real *x, integer *lenx,
	...
	ier)
{
    ...
    /* Local variables */
    static integer ier1;
    extern /* Subroutine */ int sintf1_(integer *, integer *, real *, real *, 
	    real *, real *, integer *), xerfft_(char *, integer *, ftnlen);
