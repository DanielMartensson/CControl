/* costmb.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int costmb_(integer *lot, integer *jump, integer *n, integer 
	...
	work, integer *lenwrk, integer *ier)
{
    ...
    /* Local variables */
    static integer iw1, ier1;
    extern /* Subroutine */ int mcstb1_(integer *, integer *, integer *, 
