/* cost1b.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int cost1b_(integer *n, integer *inc, real *x, integer *lenx,
	...
	ier)
{
    ...
    /* Local variables */
    static integer ier1;
    extern /* Subroutine */ int costb1_(integer *, integer *, real *, real *, 
