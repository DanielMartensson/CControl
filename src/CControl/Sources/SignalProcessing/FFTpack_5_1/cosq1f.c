/* cosq1f.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int cosq1f_(integer *n, integer *inc, real *x, integer *lenx,
	...
	ier)
{
    ...
    static integer ier1;
    static real tsqx;
    extern /* Subroutine */ int cosqf1_(integer *, integer *, real *, real *, 
	    real *, integer *);
    static real ssqrt2;
