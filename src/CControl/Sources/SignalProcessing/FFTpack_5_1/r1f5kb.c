...
/* Subroutine */ int r1f5kb_(integer *ido, integer *l1, real *cc, integer *
	...
	wa4)
{
	...
	ch[((k + ch_dim3) * ch_dim2 + 1) * ch_dim1 + 1] = cc[((k * 5 + 1) * 
		...
		cc_dim2) * cc_dim1 + 1] * 2.f + cc[(*ido + (k * 5 + 4) * 
		cc_dim2) * cc_dim1 + 1] * 2.f;
	ch[((k + (ch_dim3 << 1)) * ch_dim2 + 1) * ch_dim1 + 1] = cc[((k * 5 + 
		1) * cc_dim2 + 1) * cc_dim1 + 1] + tr11 * 2.f * cc[(*ido + (k 
		* 5 + 2) * cc_dim2) * cc_dim1 + 1] + tr12 * 2.f * cc[(*ido + (
		k * 5 + 4) * cc_dim2) * cc_dim1 + 1] - (ti11 * 2.f * cc[((k * 
		5 + 3) * cc_dim2 + 1) * cc_dim1 + 1] + ti12 * 2.f * cc[((k * 
		5 + 5) * cc_dim2 + 1) * cc_dim1 + 1]);
	ch[((k + ch_dim3 * 3) * ch_dim2 + 1) * ch_dim1 + 1] = cc[((k * 5 + 1) 
		* cc_dim2 + 1) * cc_dim1 + 1] + tr12 * 2.f * cc[(*ido + (k * 
		5 + 2) * cc_dim2) * cc_dim1 + 1] + tr11 * 2.f * cc[(*ido + (k 
		* 5 + 4) * cc_dim2) * cc_dim1 + 1] - (ti12 * 2.f * cc[((k * 5 
		+ 3) * cc_dim2 + 1) * cc_dim1 + 1] - ti11 * 2.f * cc[((k * 5 
		+ 5) * cc_dim2 + 1) * cc_dim1 + 1]);
	ch[((k + (ch_dim3 << 2)) * ch_dim2 + 1) * ch_dim1 + 1] = cc[((k * 5 + 
		1) * cc_dim2 + 1) * cc_dim1 + 1] + tr12 * 2.f * cc[(*ido + (k 
		* 5 + 2) * cc_dim2) * cc_dim1 + 1] + tr11 * 2.f * cc[(*ido + (
		k * 5 + 4) * cc_dim2) * cc_dim1 + 1] + (ti12 * 2.f * cc[((k * 
		5 + 3) * cc_dim2 + 1) * cc_dim1 + 1] - ti11 * 2.f * cc[((k * 
		5 + 5) * cc_dim2 + 1) * cc_dim1 + 1]);
	ch[((k + ch_dim3 * 5) * ch_dim2 + 1) * ch_dim1 + 1] = cc[((k * 5 + 1) 
		* cc_dim2 + 1) * cc_dim1 + 1] + tr11 * 2.f * cc[(*ido + (k * 
		5 + 2) * cc_dim2) * cc_dim1 + 1] + tr12 * 2.f * cc[(*ido + (k 
		* 5 + 4) * cc_dim2) * cc_dim1 + 1] + (ti11 * 2.f * cc[((k * 5 
		+ 3) * cc_dim2 + 1) * cc_dim1 + 1] + ti12 * 2.f * cc[((k * 5 
		+ 5) * cc_dim2 + 1) * cc_dim1 + 1]);
/* L101: */
    }
    if (*ido == 1) {
