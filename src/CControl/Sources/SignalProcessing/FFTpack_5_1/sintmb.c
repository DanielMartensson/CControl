...
/* Subroutine */ int sintmb_(integer *lot, integer *jump, integer *n, integer 
	...
	work, integer *lenwrk, integer *ier)
{
    ...
    extern /* Subroutine */ int msntb1_(integer *, integer *, integer *, 
	...
	*ier = 4;
    ...
    iw1 = *lot + *lot + 1;
    iw2 = iw1 + *lot * (*n + 1);
    msntb1_(lot, jump, n, inc, &x[x_offset], &wsave[1], &work[1], &work[iw1], 
	    &work[iw2], &ier1);
    if (ier1 != 0) {
	*ier = 20;
