/* mradb5.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int mradb5_(integer *m, integer *ido, integer *l1, real *cc, 
	...
	real *wa1, real *wa2, real *wa3, real *wa4)
{
	...
	for (m1 = 1; i__3 < 0 ? m1 >= i__2 : m1 <= i__2; m1 += i__3) {
	    ...
	    ch[m2 + ((k + ch_dim3) * ch_dim2 + 1) * ch_dim1] = cc[m1 + ((k * 
		    ...
		    + 2) * cc_dim2) * cc_dim1] * 2.f + cc[m1 + (*ido + (k * 5 
		    + 4) * cc_dim2) * cc_dim1] * 2.f;
	    ch[m2 + ((k + (ch_dim3 << 1)) * ch_dim2 + 1) * ch_dim1] = cc[m1 + 
		    ((k * 5 + 1) * cc_dim2 + 1) * cc_dim1] + tr11 * 2.f * cc[
		    m1 + (*ido + (k * 5 + 2) * cc_dim2) * cc_dim1] + tr12 * 
		    2.f * cc[m1 + (*ido + (k * 5 + 4) * cc_dim2) * cc_dim1] - 
		    (ti11 * 2.f * cc[m1 + ((k * 5 + 3) * cc_dim2 + 1) * 
		    cc_dim1] + ti12 * 2.f * cc[m1 + ((k * 5 + 5) * cc_dim2 + 
		    1) * cc_dim1]);
	    ch[m2 + ((k + ch_dim3 * 3) * ch_dim2 + 1) * ch_dim1] = cc[m1 + ((
		    k * 5 + 1) * cc_dim2 + 1) * cc_dim1] + tr12 * 2.f * cc[m1 
		    + (*ido + (k * 5 + 2) * cc_dim2) * cc_dim1] + tr11 * 2.f *
		     cc[m1 + (*ido + (k * 5 + 4) * cc_dim2) * cc_dim1] - (
		    ti12 * 2.f * cc[m1 + ((k * 5 + 3) * cc_dim2 + 1) * 
		    cc_dim1] - ti11 * 2.f * cc[m1 + ((k * 5 + 5) * cc_dim2 + 
		    1) * cc_dim1]);
	    ch[m2 + ((k + (ch_dim3 << 2)) * ch_dim2 + 1) * ch_dim1] = cc[m1 + 
		    ((k * 5 + 1) * cc_dim2 + 1) * cc_dim1] + tr12 * 2.f * cc[
	    ...
	    ch[m2 + ((k + ch_dim3 * 5) * ch_dim2 + 1) * ch_dim1] = cc[m1 + ((
		    k * 5 + 1) * cc_dim2 + 1) * cc_dim1] + tr11 * 2.f * cc[m1 
