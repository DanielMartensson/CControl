/* rfftmf.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int rfftmf_(integer *lot, integer *jump, integer *n, integer 
	...
	work, integer *lenwrk, integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int mrftf1_(integer *, integer *, integer *, 
