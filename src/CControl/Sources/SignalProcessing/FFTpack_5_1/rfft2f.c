/* rfft2f.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int rfft2f_(integer *ldim, integer *l, integer *m, real *r__,
	...
	ier)
{
    ...
    extern /* Subroutine */ int cfftmf_(integer *, integer *, integer *, 
	    ...
	    , integer *), rfftmf_(integer *, integer *, integer *, integer *, 
...
/*     OF THE INPUT TO COMPLEX CFFTMF MUST BE EVEN. */
	...
	i__2 = ldh * *m;
	i__3 = *l * *m;
	cfftmf_(&i__1, &c__1, m, &ldh, &work[2], &i__2, &wsave[lwsav + 1], &
