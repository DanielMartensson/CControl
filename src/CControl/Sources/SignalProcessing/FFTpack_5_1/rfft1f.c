/* rfft1f.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int rfft1f_(integer *n, integer *inc, real *r__, integer *
	...
	integer *ier)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int rfftf1_(integer *, integer *, real *, real *, 
	    real *, real *), xerfft_(char *, integer *, ftnlen);
