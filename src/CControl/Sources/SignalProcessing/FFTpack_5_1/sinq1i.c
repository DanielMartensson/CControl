/* sinq1i.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int sinq1i_(integer *n, real *wsave, integer *lensav, 
	integer *ier)
{
    /* Builtin functions */
    ...
    /* Local variables */
    static integer ier1;
    extern /* Subroutine */ int cosq1i_(integer *, real *, integer *, integer 
