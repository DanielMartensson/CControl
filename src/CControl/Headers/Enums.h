...
/* For clustersdistance.c */
typedef enum {
	CLUSTER_DISTANCE_METHOD_EUCLIDEAN_DISTANCE,
	CLUSTER_DISTANCE_METHOD_HORIZONTAL_DISTANCE,
	CLUSTER_DISTANCE_METHOD_VERTICAL_DISTANCE,
	CLUSTER_DISTANCE_METHOD_ANGLE_DISTANCE
