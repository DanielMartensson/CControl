...
/* For haarlike.c */
typedef enum {
	HARLIIKE_FEATURE_CHOICE_EDGE_VERTICAL,
	HARLIIKE_FEATURE_CHOICE_EDGE_HORIZONTAL,
	HARLIIKE_FEATURE_CHOICE_LINE_VERTICAL,
	HARLIIKE_FEATURE_CHOICE_LINE_HORIZONTAL,
	HARLIIKE_FEATURE_CHOICE_CENTER,
	HARLIIKE_FEATURE_CHOICE_SQUARES
}HARLIIKE_FEATURE_CHOICE;
